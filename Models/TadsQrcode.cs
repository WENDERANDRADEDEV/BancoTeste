...
public partial class TADS_QRCODE_02 {
    ...
    /// </summary>
    [MaybeNull]
    public static TadsQrcode tadsQrcode
    {
        get => HttpData.Resolve<TadsQrcode>("TADS_QRCODE");
        set => HttpData["TADS_QRCODE"] = value;
    }

    /// <summary>
    /// Table class for TADS_QRCODE
    /// </summary>
    public class TadsQrcode : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> COD;

        public readonly DbField<SqlDbType> DES;

        public readonly DbField<SqlDbType> CMD;

        public readonly DbField<SqlDbType> FRM;

        public readonly DbField<SqlDbType> LBL;

        public readonly DbField<SqlDbType> COR;

        public readonly DbField<SqlDbType> ETAPA;

        public readonly DbField<SqlDbType> QRCODE;

        public readonly DbField<SqlDbType> QRCODE2;
        ...
        public TadsQrcode()
        {
            ...
            Name = "TADS_QRCODE";
            Type = "TABLE";
            UpdateTable = "dbo.TADS_QRCODE"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // COD
            COD = new (this, "x_COD", 200, SqlDbType.VarChar) {
                Name = "COD",
                Expression = "[COD]",
                UseBasicSearch = true,
                BasicSearchExpression = "[COD]",
                DateTimeFormat = -1,
                VirtualExpression = "[COD]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "COD", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("COD", COD);

            // DES
            DES = new (this, "x_DES", 200, SqlDbType.VarChar) {
                Name = "DES",
                Expression = "[DES]",
                UseBasicSearch = true,
                BasicSearchExpression = "[DES]",
                DateTimeFormat = -1,
                VirtualExpression = "[DES]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "DES", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DES", DES);

            // CMD
            CMD = new (this, "x_CMD", 200, SqlDbType.VarChar) {
                Name = "CMD",
                Expression = "[CMD]",
                UseBasicSearch = true,
                BasicSearchExpression = "[CMD]",
                DateTimeFormat = -1,
                VirtualExpression = "[CMD]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "CMD", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("CMD", CMD);

            // FRM
            FRM = new (this, "x_FRM", 200, SqlDbType.VarChar) {
                Name = "FRM",
                Expression = "[FRM]",
                UseBasicSearch = true,
                BasicSearchExpression = "[FRM]",
                DateTimeFormat = -1,
                VirtualExpression = "[FRM]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "FRM", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("FRM", FRM);

            // LBL
            LBL = new (this, "x_LBL", 200, SqlDbType.VarChar) {
                Name = "LBL",
                Expression = "[LBL]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LBL]",
                DateTimeFormat = -1,
                VirtualExpression = "[LBL]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "LBL", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LBL", LBL);

            // COR
            COR = new (this, "x_COR", 200, SqlDbType.VarChar) {
                Name = "COR",
                Expression = "[COR]",
                UseBasicSearch = true,
                BasicSearchExpression = "[COR]",
                DateTimeFormat = -1,
                VirtualExpression = "[COR]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "COR", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("COR", COR);

            // ETAPA
            ETAPA = new (this, "x_ETAPA", 200, SqlDbType.VarChar) {
                Name = "ETAPA",
                Expression = "[ETAPA]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ETAPA]",
                DateTimeFormat = -1,
                VirtualExpression = "[ETAPA]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "ETAPA", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ETAPA", ETAPA);

            // QRCODE
            QRCODE = new (this, "x_QRCODE", 204, SqlDbType.VarBinary) {
                Name = "QRCODE",
                Expression = "[QRCODE]",
                BasicSearchExpression = "[QRCODE]",
                DateTimeFormat = -1,
                VirtualExpression = "[QRCODE]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "QRCODE", "CustomMsg"),
                IsUpload = true
            };
            Fields.Add("QRCODE", QRCODE);

            // QRCODE2
            QRCODE2 = new (this, "x_QRCODE2", 201, SqlDbType.Text) {
                Name = "QRCODE2",
                Expression = "[QRCODE2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[QRCODE2]",
                DateTimeFormat = -1,
                VirtualExpression = "[QRCODE2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("TADS_QRCODE", "QRCODE2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("QRCODE2", QRCODE2);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                COD.DbValue = row["COD"]; // Set DB value only
                DES.DbValue = row["DES"]; // Set DB value only
                CMD.DbValue = row["CMD"]; // Set DB value only
                FRM.DbValue = row["FRM"]; // Set DB value only
                LBL.DbValue = row["LBL"]; // Set DB value only
                COR.DbValue = row["COR"]; // Set DB value only
                ETAPA.DbValue = row["ETAPA"]; // Set DB value only
                QRCODE.Upload.DbValue = row["QRCODE"];
                QRCODE2.DbValue = row["QRCODE2"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "TadsQrcodeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TadsQrcodeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TadsQrcodeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TadsQrcodeView",
                Config.ApiAddAction => "TadsQrcodeAdd",
                Config.ApiEditAction => "TadsQrcodeEdit",
                Config.ApiDeleteAction => "TadsQrcodeDelete",
                Config.ApiListAction => "TadsQrcodeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TadsQrcodeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TadsQrcodeView", parm);
            else
                url = KeyUrl("TadsQrcodeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TadsQrcodeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TadsQrcodeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TadsQrcodeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TadsQrcodeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TadsQrcodeList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("TadsQrcodeDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            ID.SetDbValue(dr["ID"]);
            COD.SetDbValue(dr["COD"]);
            DES.SetDbValue(dr["DES"]);
            CMD.SetDbValue(dr["CMD"]);
            FRM.SetDbValue(dr["FRM"]);
            LBL.SetDbValue(dr["LBL"]);
            COR.SetDbValue(dr["COR"]);
            ETAPA.SetDbValue(dr["ETAPA"]);
            QRCODE.Upload.DbValue = dr["QRCODE"];
            QRCODE2.SetDbValue(dr["QRCODE2"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "TadsQrcodeList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(COD);
                        doc.ExportCaption(DES);
                        doc.ExportCaption(CMD);
                        doc.ExportCaption(FRM);
                        doc.ExportCaption(LBL);
                        doc.ExportCaption(COR);
                        doc.ExportCaption(ETAPA);
                        doc.ExportCaption(QRCODE);
                        doc.ExportCaption(QRCODE2);
                    } else {
                        doc.ExportCaption(ID);
                        doc.ExportCaption(COD);
                        doc.ExportCaption(DES);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(COD);
                            await doc.ExportField(DES);
                            await doc.ExportField(CMD);
                            await doc.ExportField(FRM);
                            await doc.ExportField(LBL);
                            await doc.ExportField(COR);
                            await doc.ExportField(ETAPA);
                            await doc.ExportField(QRCODE);
                            await doc.ExportField(QRCODE2);
                        } else {
                            await doc.ExportField(ID);
                            await doc.ExportField(COD);
                            await doc.ExportField(DES);

...
public partial class TADS_QRCODE_02 {
    ...
    /// tadsQrcodeDelete
    /// </summary>
    public static TadsQrcodeDelete tadsQrcodeDelete
    {
        get => HttpData.Get<TadsQrcodeDelete>("tadsQrcodeDelete")!;
        set => HttpData["tadsQrcodeDelete"] = value;
    }

    /// <summary>
    /// Page class for TADS_QRCODE
    /// </summary>
    public class TadsQrcodeDelete : TadsQrcodeDeleteBase
    {
        // Constructor
        public TadsQrcodeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TadsQrcodeDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TadsQrcodeDeleteBase : TadsQrcode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tadsQrcodeDelete";
        ...
        // Page name
        public string PageName => "TadsQrcodeDelete";
        ...
        // Constructor
        public TadsQrcodeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("TadsQrcodeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("TadsQrcodeList"); // Return to list
                }
            }

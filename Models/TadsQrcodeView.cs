...
public partial class TADS_QRCODE_02 {
    ...
    /// tadsQrcodeView
    /// </summary>
    public static TadsQrcodeView tadsQrcodeView
    {
        get => HttpData.Get<TadsQrcodeView>("tadsQrcodeView")!;
        set => HttpData["tadsQrcodeView"] = value;
    }

    /// <summary>
    /// Page class for TADS_QRCODE
    /// </summary>
    public class TadsQrcodeView : TadsQrcodeViewBase
    {
        // Constructor
        public TadsQrcodeView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TadsQrcodeView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TadsQrcodeViewBase : TadsQrcode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tadsQrcodeView";
        ...
        // Page name
        public string PageName => "TadsQrcodeView";
        ...
        // Constructor
        public TadsQrcodeViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "TadsQrcodeList"; // Return to list
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fTADS_QRCODEview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";

...
public partial class TADS_QRCODE_02 {
    ...
    /// tadsQrcodeAdd
    /// </summary>
    public static TadsQrcodeAdd tadsQrcodeAdd
    {
        get => HttpData.Get<TadsQrcodeAdd>("tadsQrcodeAdd")!;
        set => HttpData["tadsQrcodeAdd"] = value;
    }

    /// <summary>
    /// Page class for TADS_QRCODE
    /// </summary>
    public class TadsQrcodeAdd : TadsQrcodeAddBase
    {
        // Constructor
        public TadsQrcodeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TadsQrcodeAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TadsQrcodeAddBase : TadsQrcode
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tadsQrcodeAdd";
        ...
        // Page name
        public string PageName => "TadsQrcodeAdd";
        ...
        // Constructor
        public TadsQrcodeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("TadsQrcodeList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "TadsQrcodeView")

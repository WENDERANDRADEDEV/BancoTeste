...
public partial class TADS_QRCODE_02 {
    ...
    public static partial class Config
    {
        ...
        // Product version
        public const string ProductVersion = "20.8.0";

        // Project
        public const string ProjectNamespace = "ASPNETMaker2023";

        public const string ProjectClassName = "ASPNETMaker2023.Models.TADS_QRCODE_02"; // DN
        ...
        public const string ProjectName = "TADS_QRCODE_02"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{CC2C6F46-3970-4EF2-BEBD-4F3187212A89}"; // Project ID (GUID)

        public static string RandomKey = "isec31lxWeLO7FGT"; // Random key for encryption

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/TADS_QRCODE_02.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        public static string SidebarClass = "main-sidebar sidebar-dark-blue"; // CSS class(es) for sidebar

        public static string NavbarClass = "main-header navbar navbar-expand navbar-blue navbar-dark border-bottom-0"; // CSS class(es) for navbar
        ...
        // Export Log
        public static string ExportPath = "export-cc2c6f46-3970-4ef2-bebd-4f3187212a89"; // Export folder
        ...
        public static string SubscriptionFieldNameContentEncoding = ""; // Subscription Content Encoding field name
        ...
        {
            new object[] { 1, "mi_TADS_QRCODE", "1", "TadsQrcodeList", -1, "", true, false, false, "", "", false, true }
        };

...
public partial class TADS_QRCODE_02 {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(TADS_QRCODE_02).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(TADS_QRCODE_02).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
